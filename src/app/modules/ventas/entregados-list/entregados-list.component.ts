...
@Component({
  selector: 'app-entregados-list',
  templateUrl: './entregados-list.component.html',
  styleUrls: ['./entregados-list.component.scss']
})
export class EntregadosListComponent implements OnInit {
  ...
  listarPedidos(){
    this.ventaService.listEntregados().subscribe(
      (res:any)=>{
        console.log(res);
